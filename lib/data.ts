export type WorkCategory = "tufting" | "embroidery" | "painting" | "photography" | "mixed";
...
export const works: Work[] = [
  ...
  // Candy II–VII + Candy Cane added 2026-07-18 — the full Dropbox sweep found 7 more
  // distinct pieces in this series; each visually confirmed as a different shape/colorway.
  { slug: 'candy-ii',    title: 'Candy II',    category: 'tufting', year: '2021', description: 'A lollipop on a stick, cut pile, in a patchwork of navy, orange, olive, and steel blue — the shape of the series\' template, a different colour argument each time.', image: `${BLOB}/tufting/candy-ii.jpg`, gallery: g('tufting/candy-ii', 1) },
  { slug: 'candy-iii',   title: 'Candy III',   category: 'tufting', year: '2021', description: 'A lollipop tree, teal and navy ground with pink, mint, and neon-green patches breaking across it — looser and more organic than the others in the series.', image: `${BLOB}/tufting/candy-iii.jpg`, gallery: g('tufting/candy-iii', 1) },
  { slug: 'candy-iv',    title: 'Candy IV',    category: 'tufting', year: '2021', description: 'A round piece, 26×24 cm, mixing plain wool with beaded and sequinned thread — pink and red at the centre, green at the edge, texture doing as much work as colour.', dimensions: '26×24 cm', materials: 'Hand-tufted wool with beading and sequin thread', image: `${BLOB}/tufting/candy-iv.jpg`, gallery: g('tufting/candy-iv', 1) },
  // Gallery updated 2026-08-02 — the only image on file was a tight macro crop with no
  // full shot anywhere. Added a genuine full-piece photo from Dropbox as gallery[0]
  // (image audit). Note: this photo reads as a hook/cane shape, not a closed ring/doughnut —
  // the description above may need a second look against the real piece.
  { slug: 'candy-v',     title: 'Candy V',     category: 'tufting', year: '2021', description: 'A ring, cut and loop pile mixed in the same piece, green and orange on white — the shape closer to a doughnut than a lollipop.', image: `${BLOB}/tufting/candy-v.jpg`, gallery: [2, 1].map(i => `${BLOB}/tufting/candy-v/gallery/${i}.jpg`) },
  { slug: 'candy-vi',    title: 'Candy VI',    category: 'tufting', year: '2021', description: 'A lollipop with a metallic gold tinsel accent at the top edge — pink, red, navy, and purple underneath, the sparkle the one departure from plain wool in the whole series.', materials: 'Hand-tufted wool with metallic tinsel accent', image: `${BLOB}/tufting/candy-vi.jpg`, gallery: g('tufting/candy-vi', 1) },
  { slug: 'candy-cane',  title: 'Candy Cane',  category: 'tufting', year: '2021', description: 'The literal shape this time — a striped cane in navy and pink, cut pile, white outline. The most direct piece in the series; everything else in it is an abstraction of the same idea.', image: `${BLOB}/tufting/candy-cane.jpg`, gallery: g('tufting/candy-cane', 1) },
  { slug: 'candy-vii',   title: 'Candy VII',   category: 'tufting', year: '2021', description: 'A round lollipop, teal and pink swirled with orange and a small looped-yellow accent at the centre — the most classically "candy" of the series in silhouette.', image: `${BLOB}/tufting/candy-vii.jpg`, gallery: g('tufting/candy-vii', 1) },
  ...
  { slug: 'birds',             title: 'Birds',             category: 'tufting', year: '2021', description: 'Wool tufting on canvas. Three bird silhouettes in flight across a white ground. Graphic, fast — the kind of image that only works when you don\'t try to add detail.',                                                    image: `${BLOB}/tufting/birds.jpg`,             gallery: [`${BLOB}/tufting/birds.jpg`, ...g('tufting/birds', 5)] },
  { slug: 'du-und',            title: 'Du und',            category: 'tufting', year: '2021', description: '"Du und" — you and — in German. The sentence stopped mid-phrase. The blank after it is part of the work. In cut pile on a large canvas; the letters are the image.',                                                      image: `${BLOB}/tufting/du-und/gallery/3.jpg`,  gallery: g('tufting/du-und', 5) },
  ...
  { slug: 'fleur-de-lys',      title: 'Fleur de Lys',      category: 'tufting', year: '2021', description: 'The heraldic lily in wool pile — a symbol with centuries of weight, remade in domestic material. What does power look like when you build it thread by thread?',                                                           image: `${BLOB}/tufting/fleur-de-lys.jpg`, gallery: g('tufting/fleur-de-lys', 1) },
  ...
  { slug: 'rainbow-iii',       title: 'Rainbow III',       category: 'tufting', year: '2021', description: 'A third arc, hot pink and orange giving way to a longer cut-pile navy fringe at the centre — the only one in the series where the pile height itself changes across the piece, not just the colour.',                        image: `${BLOB}/tufting/rainbow-iii.jpg`,       gallery: g('tufting/rainbow-iii', 1) },
  { slug: 'rainbow-iv',        title: 'Rainbow IV',        category: 'tufting', year: '2021', description: 'A fourth arc in navy, lime, and gold, with a thread of metallic silver between the bands and a tiny hand-stitched infinity mark tucked into one corner — the only rainbow in the series carrying the studio\'s own signature.',    image: `${BLOB}/tufting/rainbow-iv.jpg`,        gallery: g('tufting/rainbow-iv', 1) },
  { slug: 'tufted-mask',       title: 'Tufted Mask',       category: 'tufting', year: '2021', description: 'A mask form tufted in dense loop pile. 39×21 cm. Between a ritual object and something you might find in a museum behind glass. Made with wool by hand in Copenhagen. Sold.',                      dimensions: '39×21 cm', image: `${BLOB}/tufting/tufted-mask/gallery/4.jpg`,       gallery: g('tufting/tufted-mask', 5), sold: true },
  ...
  { slug: 'sitspot-large',     title: 'Sitspot Large',     category: 'tufting', year: '2021', description: 'Originally designed to sit on — a functional object made seriously. High-pile cut wool. Fine art and utility occupying the same object. The large version; the small version no longer exists.',              image: `${BLOB}/tufting/sitspot-large.jpg`,     gallery: g('tufting/sitspot-large', 6) },
  ...
  { slug: 'small-round-tricolor', title: 'Small Round Tricolor', category: 'tufting', year: '2021', description: 'A small round piece, 24×21 cm, in white, blue, and red — a face-like arrangement with a scatter of navy dots and a few flecks of gold thread worked in.', dimensions: '24×21 cm', image: `${BLOB}/tufting/small-round-tricolor.jpg`, gallery: g('tufting/small-round-tricolor', 1) },
  { slug: 'square-flower-thing', title: 'Square Flower Thing', category: 'tufting', year: '2021', description: 'Purple ground with gold and crimson breaking in from one corner, green line-work cut through the centre. 34×23 cm — a different, more graphic take on the floral abstractions elsewhere in the archive.', dimensions: '34×23 cm', image: `${BLOB}/tufting/square-flower-thing.jpg`, gallery: g('tufting/square-flower-thing', 1) },
  { slug: 'green-square',       title: 'Green Square',       category: 'tufting', year: '2021', description: 'A large abstract landscape in green, teal, and navy, 60×51 cm — the largest piece in this palette, built from dozens of small angular fields of colour rather than a few big gestures.', dimensions: '60×51 cm', image: `${BLOB}/tufting/green-square.jpg`, gallery: g('tufting/green-square', 1) },
  ...
  // Cache-busted with ?v=2 — bedroom-rug and bedroom-wall-rug both had their Blob content
  // replaced 2026-07-17 (bedroom-rug was a watermarked, wrongly-titled promo shot of a
  // different piece; both turned out to document the same physical rug). See LOG.md.
  { slug: 'bedroom-rug',       title: 'Bedroom Rug',      category: 'tufting', year: '2020', description: 'Wool tufting, made for a specific bedroom in a specific apartment. When the piece moved on, something of the room moved with it. Made to live with — which is different from made to be seen.',                           image: `${BLOB}/tufting/bedroom-rug.jpg?v=2`,       gallery: g('tufting/bedroom-rug', 5).map(u => `${u}?v=2`) },
