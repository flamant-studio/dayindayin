...
export const works: Work[] = [
  ...
  { slug: 'stripes-on-beige', title: 'Stripes on Beige',  category: 'tufting', year: '2021', description: 'Hand-tufted wool on cotton canvas, 22×22 cm. Horizontal stripes in cut pile on a warm ground — a study in restraint. The beige is not background; it is one of the colours. Five stripes in close tonal range, each catching light slightly differently.', dimensions: '22×22 cm', image: `${BLOB}/tufting/stripes-on-beige.jpg`, gallery: g('tufting/stripes-on-beige', 5) },
