...
export const works: Work[] = [
  ...
  { slug: 'candy-v',     title: 'Candy V',     category: 'tufting', year: '2021', description: 'A ring, cut and loop pile mixed in the same piece, green and orange on white — the shape closer to a doughnut than a lollipop.', image: `${BLOB}/tufting/candy-v.jpg`, gallery: g('tufting/candy-v', 1) },
