...
export const works: Work[] = [
  ...
  { slug: 'green-on-blue',       title: 'Green on Blue',       category: 'painting', year: '2021', description: 'Acrylic on canvas. Green laid over blue — the boundary between them is where the painting lives. Each colour changes in contact with the other. A study in adjacency.',                                                   image: `${BLOB}/painting/green-on-blue.jpg` },
  ...
  { slug: 'dead-flowers',              title: 'Dead Flowers',              category: 'photography', year: '2021', description: 'Dried flowers photographed close up. After the bloom there is a different kind of beauty — drier, more structural, more architectural. This is a photograph of what remains. Archival inkjet print.',                            image: `${BLOB}/photography/dead-flowers.jpg` },
  ...
  { slug: 'purple-flower',             title: 'Purple Flower',             category: 'photography', year: '2021', description: 'One purple flower, photographed until the colour was right. Stine has been photographing single flowers since 2019 — each a study in how colour behaves when it has nothing to compete with. Archival inkjet print.',           image: `${BLOB}/photography/purple-flower.jpg` },
];
